...
class QuizzsControllerTest < ActionController::TestCase
  ...
  test "should create quizz" do
    assert_difference('Quizz.count') do
      post :create, quizz: { author: @quizz.author, description: @quizz.description, overall_rating: @quizz.overall_rating, question_total: @quizz.question_total, title: @quizz.title }
    end
  ...
  test "should update quizz" do
    patch :update, id: @quizz, quizz: { author: @quizz.author, description: @quizz.description, overall_rating: @quizz.overall_rating, question_total: @quizz.question_total, title: @quizz.title }
    assert_redirected_to quizz_path(assigns(:quizz))
  end
